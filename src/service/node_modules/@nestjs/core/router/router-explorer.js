...
class RouterExplorer {
    ...
    applyPathsToRouterProxy(router, routePaths, instanceWrapper, module, basePath, host) {
        (routePaths || []).forEach(pathProperties => {
            const { path, requestMethod } = pathProperties;
            this.applyCallbackToRouter(router, pathProperties, instanceWrapper, module, basePath, host);
    ...
    getContextId(request) {
        ...
        return context_id_factory_1.createContextId();
    }
}
